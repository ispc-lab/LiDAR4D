...
def get_arg_parser():
    ...
    ### LiDAR4D
    parser.add_argument("--min_resolution", type=int, default=64, help="minimum resolution for planes")
    ...
    parser.add_argument("--time_resolution", type=int, default=25, help="temporal resolution")
    ...
    parser.add_argument("--num_layers_flow", type=int, default=8, help="num_layers of flownet")
    parser.add_argument("--hidden_dim_flow", type=int, default=128, help="hidden_dim of flownet")
